...
TEST(leetcode_226_invert_binary_tree, Basic)
{
    ...
    //1
    TreeNode *root = tree_init({"4", "2", "7", "1", "3", "6", "9"});
    TreeNode *expected = tree_init({"4", "7", "2", "9", "6", "3", "1"});
    EXPECT_TRUE(tree_equal(expected, solution->invertTree(root)));
    root = tree_init({"4", "2", "7", "1", "3", "6", "9"});
    EXPECT_TRUE(tree_equal(expected, solution->invertTree2(root)));

    //2
    root = tree_init({"37","-34","-48","#","-100","-100","48","#","#","#","#","-54","#","-71","-22","#","#","#","8"});
    expected = tree_init({"37","-48","-34","48","-100","-100","#","#","-54","#","#","#","#","-22","-71","8"});
    EXPECT_TRUE(tree_equal(expected, solution->invertTree(root)));
    root = tree_init({"37","-34","-48","#","-100","-100","48","#","#","#","#","-54","#","-71","-22","#","#","#","8"});
    EXPECT_TRUE(tree_equal(expected, solution->invertTree2(root)));

    //3
    root = tree_init({"5","2","#","4","3","1"});
    expected = tree_init({"5","#","2","3","4","#","#","#","1"});
    EXPECT_TRUE(tree_equal(expected, solution->invertTree(root)));
    root = tree_init({"5","2","#","4","3","1"});
    EXPECT_TRUE(tree_equal(expected, solution->invertTree2(root)));

    //4
    root = tree_init({"-64","12","18","-4","-53","#","76","#","-51","#","#","-93","3","#","-31","47","#","3","53","-81",
                      ...
                      "#","#","-92","-1","-98","#","#","#","#","#","#","#","39","-84","#","#","#","#","#","#","#","#","#",
                      "#","#","#","#","-93","#","#","#","98"});
    expected = tree_init({"-64","18","12","76","#","-53","-4","3","-93","#","#","-51","#","53","3","#","47","-31","#","11",
